...
final_dat_wfabc_se_minfreq <- final_dat_wfabc_se[which(max_traj>0.4),]
...
summ <- summary(dat)
dat_median <- c(695.1, 1053.2, 3095, 3999, 2844, 2740)
dat_1st_quan <- c(669.9, 964.1, 2742, 3419, 2555, 2426)
dat_3rd_quan <- c(722.4, 1157.6, 3535, 4751, 3191, 3131)

plot(dat_median,type="o",col="red",ylim=c(0,5000),ylab="Ne",xlab="passages",lwd=3,xaxt="n")
...
boxplot(c(dat_1,dat_2,dat_3,dat_4,dat_5,dat_6,dat_7,dat_8,dat_9,dat_10,dat_11),names=protein,ylab="Ne",xlab="protein",ylim=c(0,4000),col=cm.colors(11))
```
